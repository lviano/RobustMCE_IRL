...
noisesE = ["0.05", "0.1", "0.15", "0.2", "0.25"]
...
if compute:
    ...
    save_result(data, "BallCompareAlphas_env" + str(env_type) + "size" + str(dim)+"lr"+str(lr)+noiseL+"alphaE"+alphaE+"fix_start"+str(fix_start))

else:
    data = load_result( "BallCompareAlphas_env" + str(env_type) + "size" + str(dim)+"lr"+str(lr)+noiseL+"alphaE"+alphaE+"fix_start"+str(fix_start))
...
plot_lines( list_to_plot = Vs_to_plot,
            ...
            folder = "",
            title = "BallCompare Alphas Env "+str(env_type)+" noise L "+ noiseL+"dim"+str(dim)+"alphaE"+alphaE+"fix_start"+str(fix_start),
            x_axis = noisesE)
