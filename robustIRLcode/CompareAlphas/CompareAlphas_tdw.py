...
if compute:
    ...
    save_result(data, "CompareAlphas_tdw_env" + str(env_type) + "size" + str(dim)+"lr"+str(lr)+noiseL+"alphaE"+alphaE+"fix_start"+str(fix_start))
...
plot_lines( list_to_plot = Vs_to_plot,
            ...
            folder = "",
            title = "Compare Alphas_tdw Env "+str(env_type)+" noise L "+ noiseL+"dim"+str(dim)+"alphaE"+alphaE+"fix_start"+str(fix_start),
            x_axis = noisesE)
